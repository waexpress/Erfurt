...
var BusinessesPage = (function () {
    ...
    BusinessesPage.prototype.updateList = function () {
        var _this = this;
        return this.service.fetchBusinesses(this.queryText, false, this.selectedCategory, this.orderBy)
    ...
    BusinessesPage.prototype.doRefresh = function (refresher) {
        console.log('In doRefresh() ', refresher);
